...
function clearCase(thisCase) {
    if(thisCase.nextSibling.classList.contains("active")){
        thisCase.nextSibling.setAttribute("style", "text-decoration:none");
        thisCase.nextSibling.classList.remove("active");
    }else{
        thisCase.nextSibling.setAttribute("style", "text-decoration:line-through");
        thisCase.nextSibling.classList.add("active");
    }
